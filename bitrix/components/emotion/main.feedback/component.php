...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
    ...
    if(check_bitrix_sessid())
    {
        ...
        {
            $arFields = Array(
                "AUTHOR" => $_POST["user_name"] ?: GetMessage("MF_NOT_SPECIFIED"),
                "AUTHOR_EMAIL" => $_POST["user_email"] ?: GetMessage("MF_NOT_SPECIFIED"),
                "AUTHOR_PHONE" => $_POST["user_phone"] ?: GetMessage("MF_NOT_SPECIFIED"),
                "CALL_ME" => isset($_POST["call_me"]) && $_POST["call_me"] == 'Y' ? GetMessage("MF_YES") : GetMessage("MF_NO"),
                "EMAIL_TO" => $arParams["EMAIL_TO"],
                "TEXT" => $_POST["MESSAGE"],
            );

            //PR($arFields, false, true);
            ...
            $_SESSION["MF_CALL_ME"] = htmlspecialcharsbx($_POST["call_me"]);
            $_SESSION["MF_AGREEMENT"] = htmlspecialcharsbx($_POST["AGREEMENT"]);
        ...
        $arResult["CALL_ME"] = htmlspecialcharsbx($_POST["call_me"]);
        $arResult["AGREEMENT"] = htmlspecialcharsbx($_POST["AGREEMENT"]);
    }
    else
...
if(empty($arResult["ERROR_MESSAGE"]))
{
    ...
    else
    {
        ...
        if($_SESSION["MF_CALL_ME"] <> '')
            $arResult["CALL_ME"] = htmlspecialcharsbx($_SESSION["MF_CALL_ME"]);
    }
}
