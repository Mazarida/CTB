...
?>
    ...
    <section class="bn-typical bn-knowledge-base-typical">
        <div class="bn-wrapper">
            ...
            <span class="bn-typical__text wow fadeInUpShort" data-wow-duration="1s">
                <?$APPLICATION->IncludeFile(SITE_DIR."/include/knowledge_base/knowledge_base_desc.php", Array(), Array("MODE" => "html"));?>
            </span>
            ...
            if (\Bitrix\Main\Loader::includeModule('iblock')) {
                ...
                $arFilter = Array("IBLOCK_ID" => IBLOCK_ID__KNOWLEDGE_BASE, "ACTIVE_DATE" => "Y", "ACTIVE" => "Y");
            ...
            <?
            $APPLICATION->IncludeComponent("bitrix:news.list", "knowledge_base",
                Array(
                    ...
                    "IBLOCK_ID" => IBLOCK_ID__KNOWLEDGE_BASE,	// Код информационного блока
                    ...
                    "PAGER_TITLE" => "База знаний",	// Название категорий
    ...
    <section class="bn-manuals">
        <div class="bn-wrapper">
            <h2 class="bn-h2 wow fadeInUpShort" data-wow-duration="1s">
                <span class="text--green"><?$APPLICATION->IncludeFile(SITE_DIR."/include/knowledge_base/manual_title.php", Array(), Array("MODE" => "html"));?></span>
            </h2>

            <div class="bn-manuals__grid">
                <?$APPLICATION->IncludeFile(SITE_DIR."/include/knowledge_base/manual_admin_link.php", Array(), Array("MODE" => "html"));?>
                <?$APPLICATION->IncludeFile(SITE_DIR."/include/knowledge_base/manual_user_link.php", Array(), Array("MODE" => "html"));?>
            </div>
        </div>
    </section>

    <section class="bn-contact-us">
        <div class="bn-wrapper">
            <div class="bn-form bn-contact-us__from wow fadeInUpShort" data-wow-duration="1s">
                <h3 class="bn-h3"><?$APPLICATION->IncludeFile(SITE_DIR."/include/feedback_manager_title.php", Array(), Array("MODE" => "html"));?></h3>
